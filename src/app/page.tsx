...
export default function Home() {
  return (
    <main className="bg-[#f1f1f1] flex w-full h-screen justify-center items-center">
      <div className="flex flex-col w-3/4 h-[90%] sm:w-2/4 md:flex-row md:w-[70%] md:h-2/4 xl:w-[40%] xl:h-2/3 bg-white rounded-3xl">
        <div className="bg-gradient-to-b h-[50%] md:h-full md:w-2/4 xl:w-2/4 from-indigo-500 to-indigo-800 text-white rounded-3xl text-center items-center flex flex-col">
          <p className="text-sm md:text-base md:my-7 xl:my-9 xl:text-xl opacity-70 my-5">
            Your Result
          </p>

          <div className="w-[40%] h-[38%] md:w-2/4 xl:w-[65%] xl:h-[40%] bg-gradient-to-b from-[#281979] flex flex-col rounded-full justify-center items-center">
            <p className="text-5xl md:text-7xl xl:text-7xl">76</p>
            <p className="text-xs md:text-base opacity-50">of 100</p>
          </div>

          <p className="text-xl mt-5 mb-2 md:text-2xl md:mb-3 md:mt-6 xl:text-2xl xl:mt-8">
            Great
          </p>
        ...
        <div className="px-[5%] h-[50%] pt-3 md:w-2/4 md:h-full xl:w-2/4 flex flex-col justify-between">
